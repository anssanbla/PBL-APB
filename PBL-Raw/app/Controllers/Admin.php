...
class Admin extends BaseController
{
    ...
    public function detail_favorite()
    {
        if (session()->get('username') == '') {
            session()->setFlashdata('Failed', 'Anda Belum Login');
            return redirect()->to('/login');
        ...
        $data = [
            'fav' => $this->M_Admin->getFavorite(),
        ];
        echo view('hal_admin/det_fav', $data);
    }
    ...
    public function delete_favorit($id)
    {
        ...
        $query = $this->M_Admin->deleteFavorite($id);
        if ($query) {
            return redirect()->to('/admin/detail_favorite');
        } else {
            return redirect()->to('/admin');
        }
    }
